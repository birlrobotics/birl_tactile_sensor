...
def static_data_preprocessing(data):
    global pub
    taxels1_base_values = (16884, 14131, 18246, 12081, 21928, 16342, 11646, 11801, 27208, 10953, 10925, 10974, 36376, 10554, 10482, 10776, 36159, 11215, 13934, 16362, 11855, 36329, 11364, 16047, 37449, 12054, 11610, 17657)
    taxels2_base_values = (17325, 14641, 18280, 12145, 21834, 16248, 11538, 11833, 26077, 10372, 10689, 10787, 35742, 10021, 10187, 10557, 35477, 11163, 13711, 15729, 11805, 35462, 11285, 15483, 36841, 12052, 11457, 17275)
    ...
    rospy.loginfo('tactile publishing')
    pub.publish(msg)
